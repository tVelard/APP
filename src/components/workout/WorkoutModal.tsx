...
export function WorkoutModal({ isOpen, onClose, selectedDate, onWorkoutCreated }: WorkoutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
      <div className="bg-gray-800 rounded-xl shadow-xl border border-gray-700 w-full max-w-md max-h-[90vh] overflow-hidden">
        {/* Header */}
        ...
        <div className="p-4 overflow-y-auto">
          ...
          {mode === 'select' && (
            <div className="space-y-3">
              <button
                onClick={() => setMode('new')}
                className="w-full flex items-center gap-3 p-4 border-2 border-gray-600 rounded-xl hover:border-primary-500 hover:bg-primary-900/20 transition-colors"
              >
                ...
                <div className="text-left">
                  <h3 className="font-medium text-gray-100">Nouvelle séance</h3>
                  <p className="text-sm text-gray-400">Créer une séance vide</p>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-left">
                  <h3 className="font-medium text-gray-100">Reprendre une séance</h3>
                  <p className="text-sm text-gray-400">Dupliquer une séance existante</p>
                </div>
              </button>
            </div>
          )}
          ...
          {mode === 'new' && (
            <div className="space-y-4">
              <div>
                <label htmlFor="workoutName" className="block text-sm font-medium text-gray-300 mb-1">
                  Nom de la séance
                </label>
                <input
                  id="workoutName"
            ...
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="newName" className="block text-sm font-medium text-gray-300 mb-1">
                  Nouveau nom <span className="text-gray-500">(optionnel)</span>
                </label>
                <input
                  id="newName"
                  type="text"
